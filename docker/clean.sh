...
# docker volume rm acloudfan_data-peer1.secureOrderer.com
# docker volume rm acloudfan_data-peer1.secOrg.com
# docker volume rm acloudfan_data-orderer.secureOrderer.com
