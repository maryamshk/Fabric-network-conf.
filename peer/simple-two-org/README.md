...
This will generate the secureOrdererchannel.block
...
Join the channel
================
> peer channel join -o localhost:7050 -b ./secureOrdererchannel.block
...
fetch
=====
 peer channel fetch 0 secureOrdererchannel.block -c secureOrdererchannel -o localhost:7050
