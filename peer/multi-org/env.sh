...
#export CORE_PEER_FILESYSTEMPATH=/home/vagrant/ledgers/peer/multi-org/secureOrderer/ledger
export CORE_PEER_FILESYSTEMPATH=/home/vagrant/ledgers/peer/multi-org/$ORG_NAME/ledger

#export CORE_PEER_MSPCONFIGPATH=$CONFIG_DIRECTORY/crypto-config/peerOrganizations/secureOrderer.com/peers/firstOrg/msp
