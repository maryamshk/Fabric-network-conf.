...
# E.g.,   ./sign-channel-tx.sh   secureOrderer       Signs the file with secureOrderer admin certificate/key
# E.g.,   ./sign-channel-tx.sh   secOrg     Signs the file with secOrg admin certificate/key
function usage {
