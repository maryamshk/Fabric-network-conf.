...
# E.g.,   ./sign-config-update.sh   secureOrderer       Signs the file with secureOrderer admin certificate/key
# E.g.,   ./sign-config-update.sh   secOrg     Signs the file with secOrg admin certificate/key
function usage {
