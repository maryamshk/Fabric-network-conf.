...
echo "====> 4. Enrolled Admin Identities  (Orderer, secureOrderer, secOrg)"

# 5. Setup MSP for Orgs
./setup-org-msp.sh secureOrderer
./setup-org-msp.sh orderer
./setup-org-msp.sh secOrg

echo "====> 5. Completed MSP setup for orgs (Orderer, secureOrderer, secOrg)"
